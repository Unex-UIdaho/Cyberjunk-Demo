    ...
    void tilePlacement(int x, int y, char text)
    {
        ...
        if (text == 'O')
        {
            for (int i = 0; i < scale; i++)
            {
                ...
                {
                    Instantiate(tile, new Vector3(xPos+(i*tileCoeff/scale), yPos+(j*tileCoeff/scale), 0), transform.rotation);
                }
            }
        }
        else if (text == 'Q')
        ...
        else if (text == '-')
        {
            for (int i = 0; i < scale; i++)
            {
                Instantiate(wallHorizontal, new Vector3(xPos + (i * tileCoeff / scale), yPos, 0), transform.rotation);
            }
        }
        else if (text == '_')
        {
            for (int i = 0; i < scale; i++)
            {
                Instantiate(wallHorizontal, new Vector3(xPos + (i * tileCoeff / scale), yPos + (tileCoeff / scale), 0), transform.rotation);
            }
        }
        else if (text == ']')
        {
            for (int i = 0; i < scale; i++)
            {
                Instantiate(wallVertical, new Vector3(xPos + (tileCoeff/8) + (tileCoeff / scale), yPos + (i * tileCoeff / scale), 0), transform.rotation);
            }
        }
        else if (text == '[')
        {
            for (int i = 0; i < scale; i++)
            {
                Instantiate(wallVertical, new Vector3(xPos - (tileCoeff / 8), yPos + (i * tileCoeff / scale), 0), transform.rotation);
            }
        }
        else if (text == '┐')
        {
            for (int i = 0; i < scale; i++)
            {
                ...
                {
                    if(j == 0)
                        Instantiate(wallHorizontal, new Vector3(xPos + (i * (tileCoeff/2) / scale), yPos + (j * tileCoeff / scale), 0), transform.rotation);
                    if (j == 0 && i == 1)
                        Instantiate(wallVerticalDownLeft, new Vector3(xPos + (tileCoeff / 8) + (i * tileCoeff / scale), yPos + (j * tileCoeff / scale), 0), transform.rotation);
                    if (j == 1 && i == 1)
                        Instantiate(wallVertical, new Vector3(xPos + (tileCoeff / 8) + (tileCoeff / scale), yPos + (j * tileCoeff / scale), 0), transform.rotation);
                }
            }
        }
        else if (text == '┌')
        {
            for (int i = 0; i < scale; i++)
            {
                ...
                {
                    if (j == 0)
                        Instantiate(wallHorizontal, new Vector3(xPos + ((tileCoeff/2) / scale) + (i * (tileCoeff / scale)), yPos + (j * tileCoeff / scale), 0), transform.rotation);
                    if (j == 0 && i == 0)
                        Instantiate(wallVerticalDownRight, new Vector3(xPos - (tileCoeff / 8), yPos + (j * tileCoeff / scale), 0), transform.rotation);
                    if (j == 1 && i == 1)
                        Instantiate(wallVertical, new Vector3(xPos - (tileCoeff / 8), yPos + (j * tileCoeff / scale), 0), transform.rotation);
                }
            }
        }
        else if (text == '└')
        {
            for (int i = 0; i < scale; i++)
            {
                ...
                {
                    if (j == 1)
                        Instantiate(wallHorizontal, new Vector3(xPos + (tileCoeff / 4) + (i * (tileCoeff/2) / scale), yPos + (tileCoeff / scale), 0), transform.rotation);
                    if (j == 1 && i == 0)
                        Instantiate(wallVerticalUpRight, new Vector3(xPos - (tileCoeff / 8), yPos + (tileCoeff / scale), 0), transform.rotation);
                    if (j == 1 && i == 1)
                        Instantiate(wallVertical, new Vector3(xPos - (tileCoeff / 8), yPos, 0), transform.rotation);
                }
            }
        }
        else if (text == '┘')
        {
            for (int i = 0; i < scale; i++)
            {
                ...
                {
                    if (j == 1)
                        Instantiate(wallHorizontal, new Vector3(xPos + (i * (tileCoeff / 2) / scale), yPos + (tileCoeff / scale), 0), transform.rotation);
                    if (j == 1 && i == 0)
                        Instantiate(wallVerticalUpLeft, new Vector3(xPos + (tileCoeff / 8) + (tileCoeff / scale), yPos + (tileCoeff / scale), 0), transform.rotation);
                    if (j == 1 && i == 1)
                        Instantiate(wallVertical, new Vector3(xPos + (tileCoeff / 8) + (tileCoeff / scale), yPos, 0), transform.rotation);
                }
            }
        }
        else if (text == 'L')
        {
            for (int i = 0; i < scale; i++)
            {
                ...
                {
                    if (j == 1 && i == 0)
                        Instantiate(wallVerticalDownRight, new Vector3(xPos + (tileCoeff / 8) + (tileCoeff / scale), yPos + (tileCoeff / scale), 0), transform.rotation);
                }
            }
        }
        else if (text == 'D')
        {
            for (int i = 0; i < scale; i++)
            {
                ...
                {
                    if (j == 1 && i == 0)
                        Instantiate(wallVerticalUpRight, new Vector3(xPos + (tileCoeff / 8) + (tileCoeff / scale), yPos, 0), transform.rotation);
                }
            }
        }
        else if (text == 'R')
        {
            for (int i = 0; i < scale; i++)
            {
                ...
                {
                    if (j == 1 && i == 0)
                        Instantiate(wallVerticalUpLeft, new Vector3(xPos - (tileCoeff / 8), yPos, 0), transform.rotation);
                }
            }
        }
        else if (text == 'U')
        {
            for (int i = 0; i < scale; i++)
            {
                ...
                {
                    if (j == 1 && i == 0)
                        Instantiate(wallVerticalDownLeft, new Vector3(xPos - (tileCoeff / 8), yPos + (tileCoeff / scale), 0), transform.rotation);
                }
            }
        }
    }
