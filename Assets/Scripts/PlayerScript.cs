...
public class PlayerScript : MonoBehaviour
{
    ...
    public GameObject weapon2; //This contains the Ice Weapon
    public GameObject weapon3; //This contains the Fire Weapon
    public GameObject weapon4; //This contains the Laser Weapon
        ...
        if (!Global.shopActive)
        {
            ...
            if (Mathf.Abs(Input.GetAxis("Mouse ScrollWheel")) > 0)
            {
                if (weapon)
                {
                    ...
                    {
                        weapon.GetComponent<GunScript>().destroy = true;
                        weapon = Instantiate(weapon2, transform.position, Quaternion.identity) as GameObject;
                        weaponScript = weapon.GetComponent<GunScript>();
                        weaponScript.parent = gameObject;
                        weaponScript.Hand = Hand;
                        weaponRender = weapon.GetComponent<SpriteRenderer>();
                    ...
                    {
                        weapon.GetComponent<GunScript>().destroy = true;
                        weapon = Instantiate(weapon3, transform.position, Quaternion.identity) as GameObject;
                        weaponScript = weapon.GetComponent<GunScript>();
                        weaponScript.parent = gameObject;
                        weaponScript.Hand = Hand;
                        weaponRender = weapon.GetComponent<SpriteRenderer>();
                    ...
                    {
                        weapon.GetComponent<GunScript>().destroy = true;
                        weapon = Instantiate(weapon4, transform.position, Quaternion.identity) as GameObject;
                        weaponScript = weapon.GetComponent<GunScript>();
                        weaponScript.parent = gameObject;
                        weaponScript.Hand = Hand;
                        weaponRender = weapon.GetComponent<SpriteRenderer>();
